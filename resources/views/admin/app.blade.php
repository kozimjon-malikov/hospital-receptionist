                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{ url('redirect') }}"><i class="fa fa-circle-o"></i> Main</a>
                            </li>
                            <li><a href="{{ url('add_doctor_view') }}"><i class="fa fa-circle-o"></i>Add_Doctor</a>
                            </li>
                            <li><a href="{{ url('showappointment') }}"><i class="fa fa-circle-o"></i>Show_Appointment</a>
                            </li>
                            <li><a href="{{ url('show_doctor') }}"><i class="fa fa-circle-o"></i>All doctors</a>
                            </li>
                        </ul>
                    </li>
                </ul>

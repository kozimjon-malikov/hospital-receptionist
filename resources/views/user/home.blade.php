            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (Route::has('login'))
                                    @auth
                                    <li><a class="btn btn-success mx-2" href="{{ url('myappointment') }}">My appointments</a></li>
                                     <li>
                                    ...
                                    <li><a class="btn btn-info mx-2" href="{{ route('login') }}">Register</a></li>
                                    @endauth
                                @endif
                ...
                @forelse ($doctors as $doctor)
                    <div class="item">
                        <div class="card-doctor">
                            <div class="header">
                                <img src="{{ asset('doctorsimage/' . $doctor->rasm) }}" alt="img">
                                <div class="meta">
                    ...
                    <div class="card-blog">
                        ...
                        <div class="body">
                            ...
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('frontend/assets/img/person/person_2.jpg') }}"
                                            alt="">
                                    </div>
        ...
        <div class="container py-5 py-lg-0">
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 wow fadeInRight">
                    ...
                    <a href="#"><img src="{{ asset('frontend/assets/img/google_play.svg') }}"
                            alt=""></a>
                    <a href="#" class="ml-2"><img src="{{ asset('frontend/assets/img/app_store.svg') }}"
                            alt=""></a>
                </div>
            </div>
        </div>
